  ...
  return (
    <>
      <div className="Remove_Staff_Three_Sec">
        ...
        <div className="Main_Item">
          <img
            src="https://img.freepik.com/free-photo/close-up-portrait-cheerful-glamour-girl-with-cute-make-up-smiling-white-teeth-looking-happy-camera-standing-blue-background_1258-70300.jpg?w=2000"
            alt=""
          />
          <p className="head">Rahul Sharma</p>
          <p className="desc">
