        ...
        <div className="Right">
          ...
          <div className="Main_Item">
            ...
            <div className="content">
              ...
              <ul>
                <li> <input type='checkbox' />Gangaram Hospital </li>
                <li> <input type='checkbox' /> RML Hospital  </li>
                <li> <input type='checkbox' /> MAX Hospital </li>
              ...
              <p className="addNew"><i className="fa-solid fa-plus"></i> Add New Message</p>
            </div>
          </div>
        </div>
      </div>
