...
import AllStaff from "./E-CommerceAdmin/pages/Staff/all-staff";
import CreatePateint from "./E-CommerceAdmin/pages/Patient/CreatePateint";
import AddStaff from "./E-CommerceAdmin/pages/Staff/add-staff";
import RemoveStaff from "./E-CommerceAdmin/pages/Staff/RemoveStaff";
import AllSchedule from "./E-CommerceAdmin/pages/Schedule/AllSchedule";
import OMTemplate from "./E-CommerceAdmin/pages/Template/OMTemplate";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/other-medical-create-template" element={<OMTemplate />} />
      </Routes>
    </>
  );
}
